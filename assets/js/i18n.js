...
const dictionary = {
  ...
  'nav.payrollAdvanced': { fr: 'Paie Avancée', ar: 'الأجور المتقدمة' },
  'nav.formation': { fr: 'Formation', ar: 'التكوين' },
  'nav.performance': { fr: 'Performance', ar: 'الأداء' },
  'nav.multisite': { fr: 'Multisite', ar: 'مواقع متعددة' },
  'nav.integrations': { fr: 'Intégrations', ar: 'التكاملات' },
  'nav.documents': { fr: 'Documents', ar: 'الوثائق' },
  'nav.employeePortal': { fr: 'Portail Employé', ar: 'بوابة الموظف' },
  'nav.managerPortal': { fr: 'Portail Manager', ar: 'بوابة المدير' },
  'nav.analytics': { fr: 'Analytics', ar: 'التحليلات' },
  'nav.mobility': { fr: 'Mobilité Interne', ar: 'التنقل الداخلي' },
  'nav.communication': { fr: 'Communication', ar: 'الاتصالات' },
  'nav.rgpd': { fr: 'RGPD & Conformité', ar: 'الامتثال للبيانات' },
  'nav.workflows': { fr: 'Workflows', ar: 'سير العمل' },
