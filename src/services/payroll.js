...
export const simulatePayroll = (employees, variables, params) => {
    ...
    employees.forEach((employee) => {
        ...
        const overtime = calcHeuresSup(0, varEmp.heuresSup?.jour, (varEmp.heuresSup?.nuit || 0) + (varEmp.heuresSup?.repos || 0), varEmp.heuresSup?.jourHebdo, tauxHoraire, params.overtime);
